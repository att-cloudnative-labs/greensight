...
export type TreeNodeType = 'FOLDER' | 'MODEL' | 'MODELTEMPLATE' | 'SIMULATION' | 'SIMULATIONRESULT' | 'FC_PROJECT' | 'FC_SHEET' | 'FC_VARIABLE_NUM' | 'FC_VARIABLE_BD' | 'META';
...
export interface TreeNodeAccessControlListEntry {
    id: string;
    name?: string;
    type: TreeNodeIdentityType;
    permissions: TreeNodePermission[];
}
