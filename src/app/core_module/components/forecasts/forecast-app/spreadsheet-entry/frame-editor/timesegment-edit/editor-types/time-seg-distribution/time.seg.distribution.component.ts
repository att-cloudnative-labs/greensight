import { Component, Input, HostListener, ViewChild, ElementRef, OnInit, AfterViewInit } from '@angular/core';
import { DistributionSource, DistributionSourceMethod } from '@cpt/capacity-planning-projection/lib/distribution';
...
export class TimeSegDistributionComponent implements OnInit, AfterViewInit {
    ...
    @ViewChild('dist_expression') autoCompleteComponent: AutocompleteInputComponent;
