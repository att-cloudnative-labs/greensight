...
export class TooltipsComponent {
    ...
    tooltips = new Map([
        ...
        // home.component
        ['forecast', 'Displays graphical and tabular forecast data of your project as well as the ability to add an edit variables'],
        ['system-model', 'View or edit system architecture model'],
