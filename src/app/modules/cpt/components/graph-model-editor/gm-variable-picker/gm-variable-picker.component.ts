...
import { Variable, Connection } from '@app/modules/cpt/models/graph-model.model';
import * as gmVariablePickerActions from '@app/modules/cpt/state/gm-variable-picker.actions';
