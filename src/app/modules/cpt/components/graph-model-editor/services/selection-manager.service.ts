...
import { GraphNodeDirective } from '@app/modules/cpt/components/graph-model-editor/graph-node.directive';
import { DraggableNode } from '@app/modules/cpt/models/graph-model.model';
import { GraphModel } from '@app/modules/cpt/models/graph-model.model';
...
@Injectable()
export class SelectionManagerService implements OnDestroy, OnInit {
