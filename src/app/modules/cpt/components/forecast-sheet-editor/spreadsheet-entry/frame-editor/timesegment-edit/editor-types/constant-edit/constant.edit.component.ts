...
export class ConstantEditComponent implements OnInit, AfterViewInit {
    ...
    @ViewChild('inputProjected', { static: false }) projectedInputElement: ElementRef;
    @ViewChild(TimeSegDistributionComponent, { static: false }) timeSegDistComponent: TimeSegDistributionComponent;
    @ViewChild('growthInput', { static: false }) growthInput: ElementRef;
    @ViewChild('constantInputEditor', { static: false }) constantInputEditor: ElementRef;
    ...
    */
    ...
    clickOutside(event: MouseEvent, targetElement: HTMLElement): void {
        ...
        const clickedInside = this._el.nativeElement.contains(targetElement)
            || this.constantInputEditor.nativeElement.contains(targetElement)
