...
import { Panel } from '@app/modules/cpt/state/layout.state';
import { dockableComponentsMap } from '@app/modules/cpt/components/dockable-components';
...
export class DockablePanelComponent implements OnChanges {
    ...
    loadComponent(componentName) {
        ...
        this.componentRef.instance['panelId'] = this.panel.id;
    }
}
