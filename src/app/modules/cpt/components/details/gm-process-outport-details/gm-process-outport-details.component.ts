...
import { ProcessOutport } from '@app/modules/cpt/models/graph-model.model';
import * as gmProcessOutportDetailsActions from '@app/modules/cpt/state/gm-process-outport-details.actions';

@Component({
    selector: 'app-gm-process-outport-details',
    templateUrl: './gm-process-outport-details.component.html',
    styleUrls: ['../../common.css', './gm-process-outport-details.component.css']
})
export class GmProcessOutportDetailsComponent implements OnInit, AfterViewInit {
    @Input() selected;
    @ViewChild('processOutportElement', { static: false }) processOutportElement: ElementRef;
