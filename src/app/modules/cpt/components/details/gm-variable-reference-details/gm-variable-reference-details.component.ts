...
import * as gmVariableReferenceDetailsActions from '@app/modules/cpt/state/gm-variable-reference-details.actions';
import { Modal } from 'ngx-modialog-7/plugins/bootstrap';

@Component({
    selector: 'app-gm-variable-reference-details',
    templateUrl: './gm-variable-reference-details.component.html',
    styleUrls: ['../../common.css', './gm-variable-reference-details.component.css']
})
export class GmVariableReferenceDetailsComponent implements OnInit, AfterViewInit {
    @Input() selected;
    @ViewChild('inputVarRef', { static: false }) inputElement: ElementRef;
