...
export class ForecastVariableProjection {
    ...
    constructor(public variable: any, public frames: ForecastFrame[], public variableList: ForecastVariable[]) {
        this._setup();
    }
    ...
    */
    update(variable: any, frames: ForecastFrame[], variableList: ForecastVariable[]) {
    ...
    _setup() {
        if (this.variable) {
            this.color = this.variable.variableModel.color;
        } else {
