...
import { ModalDialogService } from '@app/core_module/service/modal-dialog.service';
import { DatePickerDirective } from 'ng2-date-picker';
import { Config } from '@app/core_module/service/config';
...
export class SimulationTimelineComponent implements OnChanges {
    ...
    @ViewChild('endDateSim') endDatePickerDirective: DatePickerDirective;
    @ViewChild('startDateSim') startDatePickerDirective: DatePickerDirective;
    @Input() simulation;
