...
import { SendFolderToTrash, SendGraphModelTemplateToTrash, SendGraphModelToTrash, SendSimulationToTrash, SendSimulationResultToTrash } from '@app/modules/system-models/state/tree.actions';
...
export class TrashSearchFilterComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.actions$.pipe(ofActionSuccessful(SendFolderToTrash, SendGraphModelTemplateToTrash, SendGraphModelToTrash,
            SendSimulationToTrash, SendSimulationResultToTrash),
