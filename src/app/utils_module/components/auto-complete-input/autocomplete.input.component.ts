...
import { ForecastVariableModel } from '../../../core_module/interfaces/forecast-variable';
...
export class AutocompleteInputComponent implements OnInit, AfterViewInit, OnChanges {
    ...
    @Input('variables') variables: ForecastVariableModel[] = Array<ForecastVariableModel>();
    ...
    @ViewChild('invisibleDiv') invisibleDiv: any;
    @ViewChild('suggestedVar') suggestedVar: any;
