...
import { GraphModel, Process, Inport, Outport, ProcessPortTemplate, ProcessInterfaceDescription, GraphParam, NumberParam } from '@cpt/capacity-planning-simulation-types';
