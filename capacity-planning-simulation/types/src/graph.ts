import { ParamType, ConfigType, AspectParam, NumberParam, StringParam, BooleanParam, DateParam, NormalDistNumberParam, AspectNumberParam, ResponseNumberParam } from './param';
import { Process } from './process';
import { UidObject } from './object';

export type GraphParam = AspectParam | NumberParam | StringParam | BooleanParam | DateParam | NormalDistNumberParam | AspectNumberParam | ResponseNumberParam;
