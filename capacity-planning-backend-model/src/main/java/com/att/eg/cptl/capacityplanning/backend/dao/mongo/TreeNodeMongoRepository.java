...
public interface TreeNodeMongoRepository extends MongoRepository<TreeNode, String> {
  /**
   * Finds all nodes under a given node (identified by it's ID) in the tree. The nodes returned have
   * their content field omitted.
   *
   * @param ancestorId The ID of the ancestor to find nodes under.
   * @return The list of nodes under this node, with their content field omitted.
   */
